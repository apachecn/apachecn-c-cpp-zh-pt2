...
最好避免存储空指针，而使用库作者推荐的空对象模式。 有关空对象模式([http://www.boost.org/doc/libs/1_57_0/libs/ptr_container/doc/guidelines.html#avoid-null-pointers-in-containers-if-possible](http://www.boost.org/doc/libs/1_57_0/libs/ptr_container/doc/guidelines.html#avoid-null-pointers-in-containers-if-possible))的更多详细信息，请参阅 Boost 在线文档。
