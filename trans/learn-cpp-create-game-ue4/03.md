...
*   You can never go into both the if and the corresponding else blocks. It's always one or the other.
    ...
    ![Coding else statements](img/00037.jpeg)
...
打开**虚幻引擎启动器**应用程序(它有蓝色的 UE4 图标![Our first example with Unreal Engine](img/00038.jpeg))。 选择**启动虚幻引擎 4.4.3**，如下图所示：
...
一旦引擎启动(可能需要几秒钟)，您将进入**虚幻项目浏览器**屏幕(黑色 UE4 图标![Our first example with Unreal Engine](img/00040.jpeg))，如以下屏幕截图所示。
