...
![](assets/ff62bd89-e770-45fb-8353-9dfaac605ff5.png)
...
![](assets/0fa82e83-9f5d-4ec3-93e0-219af714867f.png)
...
![](assets/00012d43-9bf3-423a-97bf-09296f64b3d5.png)
...
![](assets/a43840c2-2d94-4263-aac9-5f780232ff57.png)
...
![](assets/670062aa-f965-46ee-9c43-1492e0f2e2ec.png)
...
![](assets/98ead175-7c85-4f0e-92e7-24b590a92b9a.png)
...
![](assets/6841a774-5537-445a-853b-887083fada8e.png)
...
![](assets/27229d49-ac56-4fe2-bdba-32a5ebdc9449.png)
...
![](assets/8c4a8a1c-1a1b-4ed3-9112-4bded8efdbb2.png)
...
![](assets/5dc6c864-8c13-42cd-8b29-f11331716833.png)
...
![](assets/eab371d1-f1f2-49ec-8133-60cc9422839a.png)
...
![](assets/ecccc094-918f-4fe3-b345-7473fb1a6cfb.png)
...
![](assets/38f742b8-1c43-4944-9ef9-e158f40cdcfd.png)
...
![](assets/1fdd3794-85d5-4feb-946b-1ad0f19576bf.png)
...
![](assets/ce8fc76f-f782-44d0-9420-f587a65d1c6d.png)
...
![](assets/e8df5cc7-1db3-44b9-b132-6ec6f6f8e7aa.png)
...
![](assets/6ee3a718-2a43-4df8-b60f-083d68ed88d4.png)

4.  要找到我们的线起点，请从数组索引中拖动另一个连接符，然后*从其中减去 1*。
5.  现在，从外路径位置拖动另一个连接器，并在搜索框中键入`Get`。 选择获取(副本)：

![](assets/7fbff992-33c2-4e33-bdff-647a3e5ac552.png)
...
![](assets/6abe0f30-f3cf-4a2a-bc6e-433261e589ad.png)
...
![](assets/e7bde58c-9e8b-41f4-b8af-0fbc6d824817.png)

让我们测试一下，看看当我们运行它时会发生什么：

![](assets/4cc4228f-796c-44ca-98ce-0bae0b3a67a1.png)
...
![](assets/a39aa2d2-d39d-426c-a319-852ff1d2f7c3.png)
...
![](assets/5b681e76-7e02-46bb-8b55-096201144bc9.png)
...
![](assets/14f0af2a-817f-4ff6-b388-0d5950bbf8a3.png)
...
![](assets/5bbdda98-cb03-419b-b6b8-ecf6fff953d6.png)
...
![](assets/886789e5-a692-4944-b19c-7660d9b5930e.png)
...
![](assets/66967fe7-325a-4f12-b74d-a59c64f782fc.png)
...
![](assets/b0efc0af-adb4-485b-8f96-660516a68778.png)

Select all the nodes connected to your Event Tick.

2.  右键单击选定节点上的任意位置，然后从上下文菜单中选择折叠以起作用：

![](assets/5faa06cf-bec0-47f9-bbc3-61a8b7a92911.png)
...
![](assets/229b9c0c-9109-4b4c-8416-7cb8c4c3f7d9.png)
...
![](assets/c18a43bd-4d09-4d9e-8c47-c982dc18ee98.png)
...
![](assets/7c7eb290-ddc7-496b-9f79-50783dd11647.png)
...
![](assets/0be22159-18b2-4344-9e65-a967eac571d2.png)
...
![](assets/8ad87534-e51e-4ae6-adef-9dd78b577393.png)
...
![](assets/45b7bca7-f17e-4d89-a1b2-191c6cbc8ea8.png)
...
![](assets/c8ba3b98-3eef-4f2a-ae12-cfbc785c2207.png)
...
![](assets/f99cd473-5018-4afe-9028-ea81c4a67c15.png)
...
![](assets/7aa921fb-c947-444c-bbdc-858b30300ebc.png)
...
![](assets/c0885e4f-a067-458d-b6ed-6693fdbb3381.png)
...
![](assets/c2fd06f3-9fce-4b09-b90f-3b5a32df5d85.png)

12.  保存并关闭材质。
13.  打开 BP_TeleportDestIndicator Blueprint 并选择 Cylider 组件。 在其详细信息|材质下，将其元素 0 材质设置为刚创建的材质。
14.  对多维数据集组件执行相同的操作：

![](assets/dd2a6360-d5d2-4fc1-8698-026e886610da.png)
...
![](assets/f310cd87-18b9-4a07-88a9-6a2de2a3e243.png)

7.  返回您的事件图，在设置远程传送方向后，将`UpdateTeleportIndicator`函数的一个实例拖到您的事件标记上：

![](assets/008ef504-8c70-4c61-975c-345356a109db.png)
...
![](assets/f863cb00-a5ce-404e-81f8-a55b66b5756d.png)
...
![](assets/3dfb86b0-ba5d-45d2-99fa-bd572fa2ac9b.png)
...
![](assets/7b604c91-b28b-48a9-b0c2-ed813606366b.png)
...
![](assets/c75ca880-5fb3-4002-a1c6-3a9c13a1f53e.png)
...
![](assets/77990d2d-83c1-4b10-8e74-62f1a81527e2.png)

我们在这里做的是使用死区检查的结果来决定我们是应该使用拇指杆输入的旋转值，还是只使用棋子现有的旋转值。 如果输入在范围的 70%或更大，我们将使用输入。 如果没有，我们就使用棋子的旋转。

![](assets/449c69d1-3aa2-45c9-8c99-c45d34631011.png)
...
![](assets/1ef14375-1ba2-4283-bcdf-b6fc98e8b2f6.png)
...
![](assets/24619ec8-7d02-4d4e-b390-81232642ca8a.png)
...
![](assets/efc934e6-a9a1-447a-9039-f83a82849f23.png)

3.  在第二个开始摄影机淡入淡出节点之后，添加另一个设置器以将`bIsTeleporting`设置为 False。
4.  将该节点的输出连接到远程端口目的地指示器的设置游戏中隐藏输入：

![](assets/caba586b-b053-4fc6-87e7-e62c68fb5c99.png)
...
![](assets/2054edc5-b7ed-45cf-b10e-b5eff2036e7d.png)
...
![](assets/f4ac2f82-d94c-452f-8fe0-d1a6e71d0d11.png)
...
![](assets/8a164f4b-9843-45c0-95bd-da158fde6cbe.png)

如果您查看 Components 选项卡，您将看到出现了一些新组件：

![](assets/471bc9c7-6b98-415e-8248-b5306e4372d3.png)
...
![](assets/9d554b16-7b84-42c7-8771-950af5758fa4.png)
...
![](assets/dc61e844-ba4b-4a61-98ff-052b8ec60503.png)
...
![](assets/c6c2c89a-e340-41d8-a7b6-d59b6597cd29.png)
...
![](assets/799912e0-21eb-4e11-b2dc-8a9d89b53da6.png)
...
![](assets/38ba6cf2-cf89-4b75-918c-67436a637a46.png)
...
![](assets/d05f8efb-9a27-42f1-aadd-3b6bdc73ad42.png)
...
![](assets/1f902968-f3a2-4811-b911-d60686b9663b.png)
...
![](assets/57e4c842-4bb3-48de-9eaf-6769f4330942.png)
...
![](assets/bdb7c99f-4f74-419f-8777-6adc185455c7.png)
...
![](assets/73b934fb-ddbd-4ba0-959f-84b9efa86ff0.png)
...
![](assets/e8ea2743-287e-434e-9f87-a628e146719e.png)
...
![](assets/c55b1d36-b0cb-4178-8381-8d5e2750dd8c.png)
