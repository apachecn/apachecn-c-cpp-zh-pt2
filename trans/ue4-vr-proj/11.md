...
![](assets/0b79cacd-6685-4290-88ac-40ea82cbc786.png)
...
![](assets/3640ba69-20cb-4b39-abca-58d50bc2ff46.png)

现在启动您的项目，或者如果它已经打开，请将其关闭并重新打开。

现在应该会出现一个对话框，指示您需要构建插件二进制文件：

![](assets/c7bc58fe-e057-43f2-a48b-2d9be7d295fb.png)
...
![](assets/d7d29455-8f0b-48c8-b9f6-f7bffae5ed8e.png)
...
![](assets/20ee2192-5b15-4ef8-94ee-0a8de82ec578.png)

点击管理插件...。 打开插件列表。

您应该看到 VRExpansion 插件的两个条目，并且这两个条目都应该被启用：

![](assets/9948cdb0-158e-43df-9035-33fbaf476014.png)
...
![](assets/41e2d270-b5d6-48a0-b8a2-65902c7cf7a0.png)
...
![](assets/4c960396-7c47-40fb-bbe8-c3f5dc0ef038.png)
...
![](assets/875a3ba1-e363-4b64-9660-8847a04f445f.png)
...
![](assets/5f4aabf0-9b7e-4d52-93ea-ee17077d47ec.png)

A view of the VR Expansion Plugin's test project. You'll find a wealth of useful VR development examples in here.

在这里玩吧。 我们不会涵盖这个示例项目中的所有内容，因为我们即将开始构建自己的项目，但是您不会浪费时间去探索足够多的内容，以便更好地了解其中包含的内容以及可以为您自己的应用程序重新分配用途的内容。
...
![](assets/d5266a44-3f4c-4da0-bab0-eb7bc953275f.png)
...
![](assets/ddae8f2f-d912-48e8-9302-33cc4160b97f.png)
...
![](assets/966de70f-524f-4afc-a471-74d8769d2e27.png)
...
![](assets/9d8d230f-ff8d-4c2d-aebd-703744ac24fc.png)
...
![](assets/4df34041-d73e-4cb0-a596-7df2468c25fa.png)
...
![](assets/3788e1d2-aab8-448a-85fa-24ef3fa96fa7.png)
...
![](assets/de743c61-b7d4-4a0d-b019-7ade40639dc0.png)
...
![](assets/3748c1ed-3b46-453c-982b-c0c46c252305.png)

这就是了。 我们的角色正在处理该输入：

![](assets/1fe78abf-ac43-4e84-9a61-b1f2e0084490.png)
...
![](assets/b53ae1c1-b260-4951-80f6-c7da504b070f.png)
...
![](assets/cb2dcc73-a9e9-44ed-b885-57bd2285c398.png)
...
![](assets/4c957c4f-7d28-4913-876d-c1ef0e0ce9d1.png)

让我们在这里也注意一些其他的事情。 您可以看到蓝图显示用黄色指示器圈起来，表示它当前正在模拟，并且您可以从标题行看到图形当前处于只读状态。 在模拟蓝图时，不允许更改蓝图：

![](assets/5d32e937-713b-4d16-8013-8047eff116cd.png)
...
![](assets/3360295a-3b4c-460a-b356-40fd9d19e608.png)
...
![](assets/f265f7c7-f8b3-417a-8346-d03025d52168.png)
...
![](assets/0e2e7e37-02c4-49f4-bf1b-76ddf2123f37.png)
...
![](assets/ddc5211e-48f5-4a3c-84df-295fb039c4ba.png)
...
![](assets/83f2aa82-6431-4211-adaa-c587a01ac1af.png)
...
![](assets/e5cdb9e3-ffc5-476a-a4e2-9712953097fd.png)
...
![](assets/7fa3ecd8-cd80-4425-baeb-20290d5124df.png)

我们可以看到，这个变量在很多地方使用，但它只在两个地方设置。 这就是我们感兴趣的：

![](assets/23491156-c90f-4b70-ae71-12d5b920f801.png)
...
![](assets/199df761-7872-4dc1-a1c2-38ecd9b5c26e.png)
